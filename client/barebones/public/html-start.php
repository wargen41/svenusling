...
echo "<nav>";
echo "<ul>";
echo "<li><a href=\"movies.php\">Betygsatta filmer</a></li>";
...
echo "<div class=\"mobile-menu-navigation\">";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-movies-rating\"></button>";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-main\"></button>";
echo "</div>";
echo "<ul>";
echo "<li><a href=\"\">+++++</a></li>";
...
echo "<div class=\"mobile-menu-navigation\">";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-movies-year\"></button>";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-main\"></button>";
echo "</div>";
echo "<ul>";
...
echo "<div class=\"mobile-menu-navigation\">";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-movies-genre\"></button>";
echo "<button popovertargetaction=\"hide\" popovertarget=\"menu-main\"></button>";
echo "</div>";
echo "<ul>";
